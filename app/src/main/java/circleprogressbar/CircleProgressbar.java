package circleprogressbar;//package com.kanyuan.circleprogressbar;
//
//import com.example.onedaydemo.R;
...
//		textSize = (int)a.getDimension(R.styleable.circleprogressbar_textSize, sp2px(this.getContext(), 70));
//		textcolor = (int)a.getColor(R.styleable.circleprogressbar_textcolor , 0xFF303030);
//		
...
//		if(finishedBorderColor == 0)
//			finishedBorderColor = 0xFF4EBBEC;
//		
//		radius = (int)a.getDimension(R.styleable.circleprogressbar_radius, sp2px(this.getContext(), 110));
//		border = (int)a.getDimension(R.styleable.circleprogressbar_border, sp2px(this.getContext(), 15));
//	}
//	@Override
...
//		canvas.drawArc(oval, -90, ((float)mprogress/mTotalProgress)*360, false, paint);
//		
//		//画完成的
//		paint.setColor(this.finishedBorderColor);		
//		canvas.drawArc(oval, angle, angle, false, paint);
//    }
//    
...
//    	canvas.drawText(text, this.getWidth()/2-txtWidth/2, this.getHeight()/2-txtHeight/2-fontMetrics.ascent, paint);	
//    }
//	/** 
