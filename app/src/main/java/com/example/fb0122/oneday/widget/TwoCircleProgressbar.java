...
public class TwoCircleProgressbar extends View{
	...
	public TwoCircleProgressbar(Context context) {
		super(context);
	}
	@SuppressLint("Recycle")
	public TwoCircleProgressbar(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		mradius = (int)a.getDimension(R.styleable.circleprogressbar_mradius, sp2px(this.getContext(), 30));
		border = (int)a.getDimension(R.styleable.circleprogressbar_border, sp2px(this.getContext(), 7));
	}
	@Override
    ...
    private int getDefaultWidth(){
    	return this.mradius * 2 + this.border * 2;
    }
    /**
     * 计算默认宽度
     */
